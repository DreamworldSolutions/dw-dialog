...
export class DwFitDialog extends LitElement {
   ...
   * Restores scroll position which is stored in last element of `window.openedDwFitDialogsInstances
   */
  unlockScroll() {
   ...
   * On `closed` removes instance from `window.openedDwFitDialogsInstances`.
