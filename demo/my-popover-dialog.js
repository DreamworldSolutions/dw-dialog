...
export class MyPopoverDialog extends DwPopoverDialog {
  ...
  get _contentTemplate() {
    return html`
    <button @click=${() => { this.renderRoot.querySelector('.more-content').style.display = 'block'; }}>Grow Content</button>
    <button @click=${() => { this.renderRoot.querySelector('.more-content').style.display = 'none';}}>Shrink Content</button>
    What is Lorem Ipsum?
